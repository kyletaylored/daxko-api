...
class InlineResponse20018Links implements ModelInterface, ArrayAccess
{
     ...
     * Sets rel
     *
     * @param string $rel This describes the relation between the link and the resource returned in the response.
     *
     * @return $this
     */
     ...
     * Sets href
     *
     * @param string $href The preconstruccted URL to the related resource.
     *
     * @return $this
     */
