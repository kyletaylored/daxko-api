...
class Body1 implements ModelInterface, ArrayAccess
{
     ...
     * Sets code
     *
     * @param string $code The authorization code that Daxko redirects to your site with via the `code` URL parameter.
     *
     * @return $this
     */
     ...
     * Sets redirect_uri
     *
     * @param string $redirect_uri The exact redirect URL that you used when you built the URL to the Daxko Operations Auth Form.
     *
     * @return $this
     */
