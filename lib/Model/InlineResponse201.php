...
class InlineResponse201 implements ModelInterface, ArrayAccess
{
     ...
     * Sets cart_id
     *
     * @param string $cart_id The ID of the cart that was created. Use this ID for any membership API calls that require the `cart_id` as a path parameter.  NOTE: This `cart_id` is only valid for membership API calls and cannot be used for any program registration API calls.
     *
     * @return $this
     */
