...
/**
 * InlineResponse20030LineItems Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20030LineItems implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_30_line_items';
    ...
    protected static $attributeMap = [
        ...
        'due_later_amount' => 'due_later_amount',
        'discounts' => 'discounts'
    ];
    ...
    protected static $setters = [
        ...
        'due_later_amount' => 'setDueLaterAmount',
    ...
    protected static $getters = [
        ...
        'due_later_amount' => 'getDueLaterAmount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['due_later_amount'] = isset($data['due_later_amount']) ? $data['due_later_amount'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['system_credit_amount'] === null) {
            $invalidProperties[] = "'system_credit_amount' can't be null";
        }
        if ($this->container['scheduled_amount'] === null) {
            $invalidProperties[] = "'scheduled_amount' can't be null";
        }
        if ($this->container['due_later_amount'] === null) {
            $invalidProperties[] = "'due_later_amount' can't be null";
        }
     ...
     *
     * @param string $product_bundle_id The ID of the product bundle this line item belongs
     *
     * @return $this
     */
     ...
     * Sets can_remove
     *
     * @param bool $can_remove Indicates whether the line_item can be deleted from the cart. For example, you can delete a program offering but not a registration fee.
     *
     * @return $this
     */
     ...
     *
     * @param float $min_payment_amount How much of the `extended_price` is due immediately.
     *
     * @return $this
     */
     ...
     *
     * @param float $payment_method_amount The amount that will be paid by the payment method.
     *
     * @return $this
     */
     ...
     *
     * @param float $system_credit_amount The amount that will be paid by system credit.
     *
     * @return $this
     */
    ...
    /**
     * Gets due_later_amount
     *
     * @return float
     */
    public function getDueLaterAmount()
    {
        return $this->container['due_later_amount'];
    }

    /**
     * Sets due_later_amount
     *
     * @param float $due_later_amount Balance if min_payment_amount is paid. This value is independent of how much is paid toward the line_item. For example, if a unit's `extended_price` is $100, and the `min_payment_amount` is $15, then the `due_later_amount` will always be $85.
     *
     * @return $this
     */
    public function setDueLaterAmount($due_later_amount)
    {
        $this->container['due_later_amount'] = $due_later_amount;
