...
class InlineResponse2011 implements ModelInterface, ArrayAccess
{
     ...
     * Sets cart_id
     *
     * @param string $cart_id The ID of the current cart. Use this ID for any cart API calls that require the `cart_id` as a path parameter.
     *
     * @return $this
     */
     ...
     * Sets member_guid
     *
     * @param string $member_guid The GUID of the member that will be used to reference the member in this cart.  Once the checkout is complete, this GUID will no longer be used to reference a member.
     *
     * @return $this
     */
