<?php
/**
 * V3membershipcartIdstatusMembers
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V3membershipcartIdstatusMembers Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V3membershipcartIdstatusMembers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v3membershipcart_idstatus_members';
     ...
     * Sets member_guid
     *
     * @param string $member_guid GUID of member to set status for.
     *
     * @return $this
     */
     ...
     * Sets active
     *
     * @param bool $active Set to `true` to mark the member as active.  Set to `false` to set the member as inactive.
     *
     * @return $this
     */
