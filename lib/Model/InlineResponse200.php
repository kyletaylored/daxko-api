...
class InlineResponse200 implements ModelInterface, ArrayAccess
{
     ...
     * Sets access_token
     *
     * @param string $access_token The issued access token.  When the grant type is `client_credentials`, the `access_token` should always be secured on your server and not be sent to a web browser or mobile device.
     *
     * @return $this
     */
     ...
     * Sets token_type
     *
     * @param string $token_type The type of token issued.
     *
     * @return $this
     */
