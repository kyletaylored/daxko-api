...
/**
 * InlineResponse2008Agreements Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2008Agreements implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_8_agreements';
     ...
     * Sets body
     *
     * @param string $body The actual text of the agreement.  Note that this content might contain HTML because Daxko Operations uses a rich text editor to allow advanced formatting.
     *
     * @return $this
     */
