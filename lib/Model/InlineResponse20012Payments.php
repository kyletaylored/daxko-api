...
/**
 * InlineResponse20012Payments Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20012Payments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_12_payments';
    ...
    protected static $swaggerTypes = [
        ...
        'description' => 'string',
        'amount' => 'float',
        'scheduled_payments' => '\Swagger\Client\Model\InlineResponse20012ScheduledPayments[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['scheduled_payments'] === null) {
            $invalidProperties[] = "'scheduled_payments' can't be null";
        }
     ...
     * Sets payment_method
     *
     * @param string $payment_method Display name of the payment payment_method
     *
     * @return $this
     */
     ...
     *
     * @param string $name_on_account Name on the payment method name_on_account
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Additional information about the payment method.  For example, for EFT and credit card payments, will be a description with the last 4 digits of the account.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\InlineResponse20012ScheduledPayments[]
     */
     ...
     *
     * @param \Swagger\Client\Model\InlineResponse20012ScheduledPayments[] $scheduled_payments Payments that have been scheduled for the future as a part of this cart.  If no payments were scheduled, then this will be empty.
     *
     * @return $this
     */
